...
import com.cgsapple.remotear.ui.home.AssistHomeScreen
import com.cgsapple.remotear.ui.home.DeviceStatusBar
import com.cgsapple.remotear.ui.home.HomeViewModel
import com.cgsapple.remotear.ui.home.rememberConnectionReady
import com.cgsapple.remotear.ui.session.CallViewModel
import com.cgsapple.remotear.ui.session.CustomerCallScreen
import com.cgsapple.remotear.ui.session.SessionEndedScreen
import com.cgsapple.remotear.ui.session.TechnicianCallScreen
import com.cgsapple.remotear.ui.session.WaitingScreen
import com.cgsapple.remotear.ui.session.WaitingViewModel
import com.cgsapple.remotear.ui.tutorial.LocalTutorialScreen
import com.cgsapple.remotear.ui.tutorial.LocalTutorialViewModel
...
private fun CallRoute(
    ...
    val context = LocalContext.current
    val isPremium = com.cgsapple.remotear.BuildConfig.IS_PREMIUM
    ...
    val openSharedFile: (com.cgsapple.remotear.data.realtime.SharedFileNotice) -> Unit = { file ->
        runCatching {
