...
import com.ggsapple.remotear.ui.call.ArTrackingStateBar
import com.ggsapple.remotear.ui.call.AssistSessionTopBar
...
fun CustomerCallScreen(
    ...
    val drawingEnabled = uiState.liveKitStarted &&
        ...
        (uiState.trackingUiState == com.ggsapple.remotear.ar.ArTrackingUiState.STABLE ||
            uiState.trackingUiState == com.ggsapple.remotear.ar.ArTrackingUiState.SURFACE_FOUND ||
...
private fun AssistCallChrome(
    ...
    Box(Modifier.fillMaxSize().zIndex(20f)) {
            ...
            if (uiState.isRecording) {
                Text(
                    ...
                    modifier = Modifier
                        ...
                        .background(com.ggsapple.remotear.ui.theme.ErrorRed.copy(alpha = 0.85f))
                        .padding(horizontal = 12.dp, vertical = 6.dp),
                    style = MaterialTheme.typography.labelMedium,
                    color = com.ggsapple.remotear.ui.theme.OnBackground,
                )
            }
            AssistSessionTopBar(
        ...
        Column(
            ...
            if (!isTechnician && uiState.trackingUiState != com.ggsapple.remotear.ar.ArTrackingUiState.STABLE) {
